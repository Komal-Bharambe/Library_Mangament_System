...
function BookForm({open,setOpen, reloadBooks, setFromType, formType, selectedBook, setSelectedBook}) {
  ...
  >
    ...
    onFinish={onFinish} initialValues={{
        ...
        <Row gutter={[20]}>
            ...
            <Col span={24}>
                <Form.Item label="Description" name="description" rules={[{required: true, message: 'Please input book title'}]}>
                    <textarea type="text"/>
                </Form.Item>
            </Col>
            ...
            <Col span={8}>
                <Form.Item label="Publisher" name="publisher" rules={[{required: true, message: "Please input publiser name"}]}>
                    <input type="text"/>
                </Form.Item>
            ...
            <Col span={8}>
                <Form.Item label="Publised Date" name="publishedDate" rules={[{required: true, message: "Please input published date"}]}>
                    <input type="date"/>
                </Form.Item>
